...
export default function CurrentPlanCard({ className = '' }: CurrentPlanCardProps) {
  return (
    <div className={`bg-gradient-to-r from-primary via-chart-2 to-chart-3 rounded-2xl p-6 text-primary-foreground relative overflow-hidden ${className}`}>
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-4">
          ...
          <button className="bg-primary-foreground/20 hover:bg-primary-foreground/30 text-primary-foreground px-4 py-2 rounded-lg text-sm font-medium transition-colors">
            Manage Plan
          </button>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-primary-foreground/20 rounded-full h-2">
              <div className="bg-primary-foreground rounded-full h-2 w-0 transition-all duration-300"></div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="bg-primary-foreground/20 rounded-full p-1 w-12 h-6 flex items-center">
              <div className="bg-primary-foreground rounded-full w-4 h-4 shadow-sm"></div>
            </div>
          </div>
        </div>
      </div>
