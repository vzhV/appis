    ...
    <ProtectedRoute>
      <NavigationLayout pageTitle="Activity Logs" pageSubtitle="Pages / Logs">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          {showFilters && (
            <div className="bg-card/80 backdrop-blur-xl shadow-lg rounded-2xl p-6 border border-border/40">
              <h3 className="text-lg font-semibold text-foreground mb-4">Filter Logs</h3>
          ...
          {/* Logs List */}
          <div className="bg-card/80 backdrop-blur-xl shadow-lg rounded-2xl border border-border/40">
            {isLoading && logs.length === 0 ? (
              ...
              <div className="p-6 text-center">
                ...
                <div className="text-muted-foreground text-sm">Activity logs will appear here as you use the application.</div>
              </div>
            ) : (
              <div className="divide-y divide-border/40">
                {logs.map((log) => {
                  ...
                  return (
                    <div key={log.id} className="p-6 hover:bg-secondary/30 transition-colors group">
                          ...
                          {log.details && Object.keys(log.details).length > 0 && (
                            <div className="mt-4 p-4 bg-secondary/30 rounded-lg border border-border/30">
                              ...
                              <div className="text-foreground text-sm">
                                <pre className="whitespace-pre-wrap font-mono text-xs bg-secondary/50 p-3 rounded border border-border">
            ...
            {hasMore && logs.length > 0 && (
              <div className="p-6 border-t border-border/40 text-center">
                <button
                  onClick={loadMore}
                  disabled={isLoading}
                  className="px-6 py-2 bg-primary hover:bg-primary/90 disabled:bg-secondary text-primary-foreground disabled:text-secondary-foreground rounded-lg transition-colors text-sm font-medium"
                >
